    ...
    const handleScroll = () => {
      if (window.scrollY > 300) {
        document
          ...
          .classList.add("bg-primary", "shadow-sm");
        document.querySelector(".sticky-top").style.top = "0px";
      } else {
        document
          .querySelector(".sticky-top")
          .classList.remove("bg-primary", "shadow-sm");
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.js"
          rel="stylesheet"
        />
        <link
          ...
          <div className="row g-5 pt-5">
            <div className="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
              ...
              <p className="text-dark mb-4 animated slideInRight">
                Engage with our advanced LLM model, Lunaris, and experience
                intelligent, seamless, and human-like conversations like never
                before.
              </p>
              <a
                href="#aboutus"
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
              <div
                className="about-img"
                style={{ backgroundImage: `url(${assets.bg_about_img})` }}
              >
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <p className="mb-4">
                Lunaris leverages the power of the Gemini API combined with
                cutting-edge machine learning and natural language processing to
                deliver intelligent, seamless, and human-like conversations.
              </p>
              <div className="row g-3">
                <div className="col-sm-6">
                  <h6 className="mb-3">
                    <i className="fa fa-check text-primary me-2"></i>Powered by
                    Gemini API
                  </h6>
                  <h6 className="mb-0">
                    <i className="fa fa-check text-primary me-2"></i>Advanced AI
                    Algorithms
                  </h6>
                </div>
                <div className="col-sm-6">
                  <h6 className="mb-3">
                    <i className="fa fa-check text-primary me-2"></i>Real-Time
                    Interaction
                  </h6>
                  <h6 className="mb-0">
              ...
              <div className="d-flex align-items-center mt-4">
                <a
                  className="btn rounded-pill px-4 me-3"
                  href=""
                  style={{
                    backgroundImage: `linear-gradient(45deg, #f6c1e1, #f7a7d7)`,
                    color: "#ffffff",
                  }}
                >
                  Follow Me
        ...
        <div className="container py-5">
          <div className="row g-5 align-items-center">
            <div className="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
              ...
              <p className="mb-4">
                Lunaris extends its versatility across various industries,
                harnessing the power of advanced AI to revolutionize fields such
                as automation, education, science, machine learning, and
                  ...
                  <div className="row g-4">
                    <div className="col-12 wow fadeIn" data-wow-delay="0.1s">
                      <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <p>
                          Empowering intelligent systems to perform tasks with
                          speed, precision, and minimal human intervention.
                        </p>
                    ...
                    <div className="col-12 wow fadeIn" data-wow-delay="0.5s">
                      <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <p>
                          Unlocking the power of data to make predictions,
                          identify patterns, and drive smarter decisions in
                          real-time.
                        </p>
                        <a className="btn px-3 mt-auto mx-auto" href="">
                          Read More
                  ...
                  <div className="row g-4">
                    <div className="col-12 wow fadeIn" data-wow-delay="0.3s">
                      <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <p>
                          Enhancing research, learning, and scientific discovery
                          through AI-powered tools and personalized experiences.
                        </p>
                        <a className="btn px-3 mt-auto mx-auto" href="">
                          Read More
                        </a>
                    ...
                    <div className="col-12 wow fadeIn" data-wow-delay="0.7s">
                      <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <p>
                          Leveraging AI to forecast trends, predict outcomes,
                          and support data-driven strategies for businesses and
                          organizations.
                        </p>
                        <a className="btn px-3 mt-auto mx-auto" href="">
                          Read More
      ...
      <div
        id="whylunaris"
        className="container-fluid feature pt-5"
        style={{
          ...
          <div className="row g-5">
            ...
            >
              ...
              <p className="text-dark mb-4">
                Lunaris provides quick, reliable, and intelligent conversations
                powered by a sophisticated AI model, similar to Gemini. Here’s
                ...
                <div className="col-sm-6">
                  ...
                  >
                    ...
                    <div className="ms-3">
                      ...
                      <p className="text-dark mb-0">Happy Users</p>
                    </div>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div
                    ...
                    style={{ background: "rgba(255, 255, 255, 0.3)" }}
                  >
                    <i className="fa fa-check fa-3x text-dark"></i>
                    <div className="ms-3">
                      <h2 className="text-dark mb-0" data-toggle="counter-up">
                        7890
                      </h2>
                      <p className="text-dark mb-0">Question Answered</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row g-4">
            <div className="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
              <div className="case-item position-relative overflow-hidden rounded mb-2">
                ...
                <a
                  ...
                  href="https://github.com/faizkhan77/EnlightenHub"
                >
                  <small>EnlightenHub</small>
                  <h5 className="lh-base text-dark mb-3">
                    A platform where users can join study rooms, collaborate
                    with others, and make new friends while learning. Ideal for
            ...
            <div className="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
              <div className="case-item position-relative overflow-hidden rounded mb-2">
                ...
                <a
                  className="case-overlay text-decoration-none"
                  href="https://github.com/faizkhan77/GestureAI"
                >
                  <small>GestureAI</small>
                  <h5 className="lh-base text-dark mb-3">
                    A computer vision-powered application that allows users to
                    control their system with simple gestures. Paint in the air
                    or navigate your device without touching anything.
                  </h5>
                  <span className="btn btn-square btn-primary">
                    <i className="fa fa-arrow-right"></i>
                  </span>
            ...
            <div className="col-lg-4 wow fadeIn" data-wow-delay="0.7s">
              <div className="case-item position-relative overflow-hidden rounded mb-2">
                ...
                <a
                  className="case-overlay text-decoration-none"
                  href="https://github.com/faizkhan77/AlzheimInsight"
                >
                  <small>AlzheimInsight</small>
                  <h5 className="lh-base text-dark mb-3">
                    A web app designed to predict whether someone is at risk for
                    Alzheimer's. Users can input basic details, and the app will
        ...
        <div className="container py-5">
          <div className="row g-5 align-items-center">
            <div className="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
              ...
              <h1 className="mb-4">Meet Insiya Rizvi</h1>
              <p className="mb-4">
                Hi, I'm Insiya Rizvi, a passionate developer, UI/UX designer,
                and data analyst. I'm currently pursuing my Master's in Computer
                Applications (MCA). I enjoy blending creativity with logic to
                design intuitive interfaces, build efficient applications, and
                extract insights from data. Welcome to my space where design,
                development, and data come together!
              </p>
              <a
              ...
              <div className="row g-4">
                <div className="col-md-6">
                  <div className="row g-4">
                    <div className="col-12 wow fadeIn" data-wow-delay="0.1s">
                      <div
                        className="team-item text-center rounded p-4 pt-0"
                        style={{
                          background: `linear-gradient(145deg, #f8e1e9, #fce8ec)`,
                        }}
                      >
                        <img
                          ...
                          src={assets.insiya_img1}
                          alt=""
                        />
                        <h5 className="mb-0">UI/UX Designer</h5>
                        <small>
                          Crafting elegant and user-friendly digital experiences
                        </small>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="col-12 wow fadeIn" data-wow-delay="0.3s">
                      ...
                      >
                        <img
                          className="img-fluid rounded-circle p-4"
                          alt=""
                          src={assets.insiya_img2}
                        />
                        <h5 className="mb-0">Data Analyst</h5>
                        <small>
                          Turning raw data into meaningful insights and visual
                          stories
                        </small>
                      </div>
                    </div>
        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
              ...
              <p className="mb-4">
                Discover how Lunaris, your trusted AI-powered chatbot, has
                helped users streamline their tasks, find solutions quickly, and
                enhance their productivity. Don’t just take our word for it,
            ...
            <div className="col-lg-7 wow fadeIn" data-wow-delay="0.5s">
              <div className="owl-carousel testimonial-carousel border-start border-primary">
                <div className="testimonial-item ps-5">
                  ...
                  <p className="fs-4">
                    Lunaris has truly transformed the way I interact with AI.
                    Whether I'm solving complex problems or just seeking quick
                    answers, Lunaris is always right on point. The seamless
                    integration and accuracy have made my workflow significantly
                    more efficient. It's like having a personal assistant who
                    never misses a beat!
                  </p>
                  <div className="d-flex align-items-center">
                    ...
                    />
                    <div className="ps-3">
                      <h5 className="mb-1" style={{ color: "#1363C6" }}>
                        Emma Brown
                      </h5>
                ...
                <div className="testimonial-item ps-5">
                  <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                  <p className="fs-4">
                    I’ve tried several chatbots in the past, but Lunaris stands
                    out because it genuinely understands the context of my
                    queries. I no longer have to waste time rephrasing my
                    questions. It’s fast, accurate, and the responses feel like
                    they’re coming from a human expert. I can’t recommend it
                    enough for anyone looking to save time!
                  </p>
                  <div className="d-flex align-items-center">
                    <img
                      className="img-fluid flex-shrink-0 rounded-circle"
                ...
                <div className="testimonial-item ps-5">
                  <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                  <p className="fs-4">
                    As someone who is passionate about artificial intelligence,
                    I have experimented with many AI models, but Lunaris truly
                    excels. The accuracy of its responses and its ability to
                    adapt to a wide range of questions makes it one of the most
                    impressive chatbots I’ve used. It’s an invaluable tool for
        ...
        <div className="container py-5">
          <div className="row g-5">
            ...
            <div className="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
              ...
              <a className="btn btn-link" href="#domains">
                Key Domains
              </a>
              <a className="btn btn-link" href="#creator">
                Creator
              </a>
