                ...
                <div className="container pt-5" style={{ backgroundImage: `url(${assets.bg_hero})` }}>
                    <div className="row g-5 pt-5">
                        <div className="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                            ...
                            <h1 className="display-4 text-white mb-4 animated slideInRight">Looking to Bring Your Ideas to Life?</h1>
                            <p className="text-white mb-4 animated slideInRight">
                                Need a cutting-edge AI model or a dynamic web application? I’m here to help!
                                As a freelance developer, I specialize in creating AI-powered solutions and scalable web apps tailored to your needs.
                                Reach out below or connect with me on <a href="https://www.linkedin.com/in/faiz-khan77/" target="_blank" className="text-light text-decoration-underline">LinkedIn</a>.
                            </p>
                            <a href="https://faizkhanpy.pythonanywhere.com/" className="btn btn-light py-sm-3 px-sm-5 rounded-pill me-3 animated slideInRight" target="_blank">Portfolio</a>
                        </div>
