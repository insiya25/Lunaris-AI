        ...
        <div className='main'>
            <div className="nav">
                ...
                <div className="user-menu">
                    {user ? (
                        <UserButton className="user-icon" appearance={{ baseTheme: dark }} />
                    ) : (
                        <>
                            <img
                                className="user-icon"
                            ...
                            {dropdownVisible && (
                                <div className="dropdown">
                                    <p className="dropdown-option" onClick={() => { navigate("/") }}>Go to Home</p>
                                    <p className="dropdown-option" onClick={() => { navigate("/signin") }}>Sign in Now</p>
                                </div>
                            )}
                        </>
                    )}
            ...
            <div className="main-container">
                ...
                {!showResult ?
                    <>
                        <div className="greet">
                            ...
                            <p className="greet-subtext">How can I illuminate your path today?</p>
                        </div>

                        <div className="cards">
                            {[
                                { prompt: "Where can I find the best travel destinations tailored to my preferences?", icon: "fas fa-compass" },
                                { prompt: "What are some innovative ideas for starting a new business?", icon: "fas fa-lightbulb" },
                                { prompt: "How can I improve my communication and presentation skills?", icon: "fas fa-comment-dots" },
                                { prompt: "What are the best practices for learning to code effectively?", icon: "fas fa-code" },
                                { prompt: "How do I maintain a healthy work-life balance while staying productive?", icon: "fas fa-balance-scale" },
                                { prompt: "What are the best tools and techniques for managing time efficiently?", icon: "fas fa-clock" }
                            ].map((card, index) => (
                                <div
                                    key={index}
                                    className="card"
                    ...
                    : <div className='result'>
                        <div className="result-title">
                            {user ? (
                                ...
                                <img className="usericon" src={assets.user_icon} alt="Default Icon" />
                            )}
                            <p>{recentPrompt}</p>
                        </div>
                ...
                <div className="main-bottom">
                    <div className="search-box">
                        <form className='inputForm'
                            ...
                            <div>
                                ...
                                <i className="fas fa-images" onClick={() => alert("Not available yet, i will update soon, else you can contribute :)")}></i>

                                {/* <img src={assets.mic_icon} alt="" /> */}
                                <i className="bi bi-mic" onClick={() => alert("Not available yet, i will update soon, else you can contribute :)")}></i>
                    ...
                    <p className="bottom-info">
                        Lunaris is greatly inspired by OpenAI's GPT and Google's Bard. While we strive for accuracy, always double-check sensitive information.
                    </p>
                </div>
