                ...
                <div className="container pt-5" style={{ backgroundImage: `url(${assets.bg_hero})` }}>
                    <div className="row g-5 pt-5">
                        <div className="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                            ...
                            <h1 className="display-4 text-white mb-4 animated slideInRight">Welcome Back to Lunaris!</h1>
                            <p className="text-white mb-4 animated slideInRight">
                                We're thrilled to have you back on Lunaris! If you're already a user, scroll down and sign in now to continue your journey with our powerful AI platform.
                                If you're new to Lunaris, don't worry, sign up now and join a growing community of innovators and creators. We're excited to help you unlock the full potential of AI!
                            </p>
                            <a onClick={() => { navigate('/signup') }} className="btn btn-light py-sm-3 px-sm-5 rounded-pill me-3 animated slideInRight" style={{
                                ...
                                }}>Sign Up to become our new member!</a>
                        </div>
...
export default HeroSectionSignin;