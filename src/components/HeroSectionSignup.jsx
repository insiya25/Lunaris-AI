          ...
          <div className="row g-5 pt-5">
            <div className="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
              ...
              <h1 className="display-4 text-dark mb-4 animated slideInRight">
                Welcome to Lunaris AI!
              </h1>
              <p className="text-dark mb-4 animated slideInRight">
                We’re thrilled to have you here! If you’re new to Lunaris, sign
                up below to unlock a world of cutting-edge AI tools and features
                designed to empower your creativity. Start your journey now and
              ...
              >
                Already a member? Sign in and continue your journey.
              </a>
            </div>
