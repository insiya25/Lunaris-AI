    ...
    return (
        <div className='sidebar'>
                ...
                {extended ? (
                    <div className="recent">
                        <p className="recent-title">Recent</p>
                        {
                            ...
                            prevPrompts.slice(-5).reverse().map((item, index) => {
                                return (
                                    <div key={index} onClick={() => loadPrompt(item)} className="recent-entry test">
            ...
            <div className="bottom">
                <div className="bottom-item recent-entry" onClick={() => alert("Not available yet, i will update soon, else you can contribute :)")}>
